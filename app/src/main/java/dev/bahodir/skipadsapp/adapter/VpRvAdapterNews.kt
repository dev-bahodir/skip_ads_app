...
class VpRvAdapterNews(var listener: OnItem) : ListAdapter<Article, VpRvAdapterNews.VH>(DU()) {
    ...
    inner class VH(var binding: VpRvItemBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        return VH(VpRvItemBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
